...
export interface LoyaltyProviderStorageInterface extends utils.Interface {
  functions: {
...
export interface LoyaltyProviderStorage extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: LoyaltyProviderStorageInterface;
